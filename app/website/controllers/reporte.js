...
function generateConfomidadReporte(data,res) {
    ...
    doc.text("Jefe de mantenimiento de terminal",50,605+extra,{width: 270,align: 'center'})
    ...
    doc.text("Superintendente de terminal",50,660+extra,{width: 270,align: 'center'})
